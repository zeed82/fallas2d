...
define([
  ...
  return declare([BaseWidget, Evented], {
    ...
    /**
     * This function is used to download the report in CSV files.
     * Solved #383 BUG-000131521 Only 10 layers downloaded using Screening widget 'Download' function in Chrome and Edge
     * When large number of files(more than 10) needs to be downloaded, multiple request were getting fired
     * in short span of time and only 10 files were downloaded. Hence, providing some delay will download all the files
     */
    _exportToCSVFile: function (layer, options, timeout) {
